...
/*
 * Event Tracker Theplus.
 */
if ( ! class_exists( 'Tpaep_Event_Tracker' ) ) {

	/**
	 * Define Tpaep_Event_Tracker class
	 */
	class Tpaep_Event_Tracker {
		...
		public function __construct() {
            add_action( 'elementor_pro/element/common/section_custom_css/after_section_end', [ $this, 'tp_event_tracket_controls' ], 10, 2 );			
			add_action( 'elementor/element/section/section_custom_css/after_section_end', [ $this, 'tp_event_tracket_controls' ], 10, 2 );					
			add_action( 'elementor/element/common/section_custom_css_pro/after_section_end', [ $this, 'tp_event_tracket_controls' ], 10, 2 );

			if ( \Elementor\Plugin::$instance->experiments->is_feature_active( 'container' ) ) {
				add_action( 'elementor/element/container/section_layout/after_section_end', [ $this, 'tp_event_tracket_controls' ], 10, 2  );
			}

			add_action( 'elementor/frontend/section/before_render', [ $this, 'tp_event_tracker_before_render'], 10, 1 );			
			add_action( 'elementor/frontend/widget/before_render', [ $this, 'tp_event_tracker_before_render' ], 10, 1 );

            if ( \Elementor\Plugin::$instance->experiments->is_feature_active( 'container' ) ) {
				add_action("elementor/frontend/container/before_render", [$this, 'tp_event_tracker_before_render'], 10, 1);
				add_action("elementor/frontend/container/after_render", [$this, 'tp_event_tracker_before_render'], 10, 1);
			}
		...
		/**
		 * Register controls for the Event Tracker feature
		 *
		 * @since 6.2.7
		 */
		public function tp_event_tracket_controls( $element, $section_id ) {

            $element->start_controls_section(
                'plus_event_tracker_options_sections',
                [
                    'label' => esc_html__( 'Events Tracker', 'theplus' ),
		...
		/**
		 * Apply Event Tracker settings before rendering the widget.
		 *
		 * @since 6.2.7
		 */
        public function tp_event_tracker_before_render( $element ) {
            ...
            $plus_eto_fb = ! empty( $settings['plus_eto_fb'] ) ? $settings['plus_eto_fb'] : '';
            ...
            /** Check & add class in elementor-element*/
...
Tpaep_Event_Tracker::get_instance();
