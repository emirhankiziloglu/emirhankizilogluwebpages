...
/*
 * Display Condition Theplus.
 */
if ( ! class_exists( 'Tpaep_Display_Condition' ) ) {

	/**
	 * Define Tpaep_Display_Condition class
	 */
	class Tpaep_Display_Condition {
...
Tpaep_Display_Condition::get_instance();
