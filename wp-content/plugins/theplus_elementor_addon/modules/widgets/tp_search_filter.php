		...
		$repeater->add_control(
			...
			array(
				...
				'options'    => array(
					...
					'lowtohighprice' => __( 'Low To High Price', 'theplus' ),
					'hightolowprice' => __( 'High To Low Price', 'theplus' ),
					'averagerating' => __( 'Average Rating', 'theplus' ),
					'latest' => __( 'Latest', 'theplus' ),
				),
		...
		if ( ! empty( $WooSorting ) ) {
			...
			if ( ! empty( $WooFiltersSelect ) ) {
				foreach ( $WooFiltersSelect as $val ) {
					...
					} elseif ( $val == 'lowtohighprice' ) {
						$WooName[ $val ] = 'Low To High Price';
					} elseif ( $val == 'hightolowprice' ) {
						$WooName[ $val ] = 'High To Low Price';
					} elseif ( $val == 'averagerating') {
						$WooName[ $val ] = 'Average Rating';
					} elseif ( $val == 'latest') {
						$WooName[ $val ] = 'Latest';
					}
				}
