...
class ThePlus_Woo_Compare extends Widget_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'tp_wc_with_url',
			array(
				'label'        => esc_html__( 'Add with Post URL', 'theplus' ),
		...
		$repeater->add_control(
			...
			array(
				...
				'condition'       => array(
					'tp_wc_field_type!' => array( 'image', 'title', 'excerpt', 'description', 'custom', 'empty', 'remove', 'post_url', 'acf' ),
				),
			)
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			...
			array(
				...
				'dynamic'   => array( 'active' => true ),
				'condition' => array(
					'tp_wc_field_type!' => array( 'image', 'title', 'remove', 'post_url', 'acf' ),
				),
			)
		);
		$repeater->add_control(
