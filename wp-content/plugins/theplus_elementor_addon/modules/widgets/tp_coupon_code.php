			...
			array(
                ...
                'raw' => sprintf(
					'<div class="tpae-preset-main-raw-main">
						<a href="%s" class="tp-preset-live-demo" id="tp-preset-live-demo" data-temp_id="16377" target="_blank" rel="noopener noreferrer">%s</a>
						<a class="tp-preset-editor-raw" id="tp-preset-editor-raw" data-temp_id="16377">%s</a>
					</div>',
					esc_url('https://theplusaddons.com/widgets/elementor-coupon-code/'),
